namespace vooltApp.sections
{
    public class Hero
    {
        ...
        public string Heading { get; set; } = "Brilliant Crafted Designs!";

        public string Text { get; set; } = "We make great designs!";
        ...
        public Uri Image { get; set; } = new Uri("https://cdn.pixabay.com/photo/2016/11/22/11/48/mountain-1849091_960_720.png");
